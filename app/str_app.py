...
day_of_week = st.number_input('Jour de la Semaine', min_value=1, max_value=7, step=1)
crs_dep_time = st.number_input('Heure de Départ CRS', min_value=0, max_value=2359, step=1)
dest_airport_id = st.number_input('ID de l’Aéroport de Destination', min_value=0, step=1)
crs_arr_time = st.number_input('Heure d’Arrivée CRS', min_value=0, max_value=2359, step=1)
